...
#define MQTT_SERVER      "192.168.43.31" // static ip address
#define MQTT_PORT         1883
#define MQTT_USERNAME    ""
#define MQTT_PASSWORD         ""
#define BUTTON_PIN  D4              // Pin connected to the button. GPIO 15 (D8) 
/************ Global State ******************/
...
Adafruit_MQTT_Publish pi_led = Adafruit_MQTT_Publish(&mqtt, MQTT_USERNAME "puerta");
...
void loop() {
  ...
  MQTT_connect();
  delay(200);
  if ((button_first == HIGH)) {
    // Button was pressed!
    Serial.println("Presencia Detectada");
    pi_led.publish("puerta abierta");
    delay(2000);
  }
